...
import com.example.tmdt.security.jwt.JwtAuthenticationFilter;
import com.example.tmdt.security.jwt.RestAuthenticationEntryPoint;
import com.example.tmdt.service.UserService;
import com.example.tmdt.service.impl.UserServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/users/**", "/wallets/**", "/categories/**","/transactions/**","/budgets/**", "/currencies/**", "/variables/**").hasAnyAuthority("ROLE_USER")
